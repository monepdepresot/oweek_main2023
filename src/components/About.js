        ...
        >
            ...
            <Container>         
                ...
                <Content>
                    ...
                    >
                        <h1>ABOUT HORIZON</h1>
                        <IsiAbout>Tema HORIZON diambil dari perpaduan kata HOPE, RISE dan EMBLAZON. HOPE diartikan sebagai harapan baru dan cita-cita mahasiswa yang bersama-sama dipupuk dari awal melalui pembelajaran dan kegiatan selama Oweek berlangsung. RISE menggambarkan aksi dan tindakan nyata yang akan diadakan mampu membuat mahasiswa bertumbuh dan lebih mengerti jalur yang mereka tempuh. EMBLAZON merepresentasikan seluruh kegiatan yg berlangsung diharapkan memberi keleluasan bagi mahasiswa untuk menghiasi masa depan yang akan mereka jalani setelah Oweek selesai. Trainee yang memulai perjalanannya di Universitas Ciputra yang harus melewati berbagai rintangan seperti O-Week, pra ldk, leadership, perkuliahan, kepanitiaan, organisasi hingga kompetisi untuk mencapai horizon yang telah mereka impikan. “Tidak ada jalan yang mudah untuk mencapai horizon namun ketika kita sudah sampai pada sebuah horizon kita semua setara.” Siapapun bisa berharap, bangkit, dan bertumbuh hingga menghiasi dalam bersama-sama mencari horizon.</IsiAbout>
                    </motion.div>
                </Content>
            </Container>
            <Topeng src={topeng} 
